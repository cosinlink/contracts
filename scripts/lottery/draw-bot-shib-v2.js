...
// v2
const lotteryContractAddress = '0x3fE74B16483e2e4b46eD17aaF9773988847F2380'
let lottery

const sendToLuckyPet = async (msg) => {
    await sendToTg(msg, 'LUCKY_PET')
}

const init = async () => {
    // !!! don't forget heco-lottery network
    // 0x326fBFcc3DbaC94Ed7d4B42193b58293785a2971
    let [storageOperator, lotteryOperator] = await ethers.getSigners()
