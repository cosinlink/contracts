...
// File contracts/pancake/interface/IPancakeRouter01.sol
...
// File contracts/pancake/interface/IPancakeRouter02.sol
...
// File contracts/pancake/interface/IPancakePair.sol
...
// File contracts/interface/IFarmManager.sol
...
interface IFarmManager {
    ...
    function handleReceiveNEWWFromTax(uint256 amount) external;

    function handleReceiveNEWWFromShare(uint256 amount) external;

    function handleReceiveBUSDToLP(uint256 amount) external;

    function handleReceiveBNBToLP(uint256 amount) external;
...
// File contracts/pancake/interface/IPancakeFactory.sol
...
// File contracts/pancake/interface/IWETH.sol
...
// File contracts/NEWWPresale.sol
...
contract NEWWPresale is TimedCrowdsale, Ownable {
    ...
    constructor(uint256 rate, IMintableERC20 token, address payable project, uint startTime, address router)
    ...
    function setToken(address token) onlyOwner public{
        _token = IMintableERC20(token);
    }

    function setFarmManager(address farmManager) onlyOwner public{
        _farmManager = IFarmManager(farmManager);
    }

    function farmManager() public view returns(address){
        return address(_farmManager);
    }
